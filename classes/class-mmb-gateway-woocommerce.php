...
class MMB_Gateway_Woocommerce {
    ...
    private function define_admin_hooks() {
        ...
        add_action('woocommerce_receipt_moneta', array($plugin_admin, 'receipt_page'));
        ...
        add_action( 'woocommerce_api_moneta', array($plugin_admin, 'handle_call_back') );
        ...
        add_action( 'woocommerce_order_action_moneta_capture_charge', array( $plugin_admin, 'maybe_capture_charge' ) );
        add_filter( 'woocommerce_order_actions', array( $plugin_admin, 'add_void_charge_order_action' ) );//add the VOID Online Order actions
        add_action( 'woocommerce_order_action_moneta_void_charge', array( $plugin_admin, 'maybe_void_charge' ) );
    }
