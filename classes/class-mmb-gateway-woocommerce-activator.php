...
class MMB_Gateway_Woocommerce_Activator
{
    ...
    public static function activate()
    {
        if (!class_exists('woocommerce')) {
            ...
            wp_die(__('Moneta Gateway for Woocommerce requires Woocommerce version 2.1 or higher', 'mmb-gateway-woocommerce'), __('Plugin Activation Error', 'mmb-gateway-woocommerce'), array('response' => 200, 'back_link' => TRUE));
