...
/**
 * Plugin Name: WooCommerce Moneta
 * Description: WooCommerce Moneta gateway integration.
 * Version: 1.1.0
 */
...
function mmb_gateway_action_links( $links ) {
    $plugin_links = array(
        '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=checkout&section=moneta' ) . '">' . __( 'Settings', 'moneta' ) . '</a>',
    );
