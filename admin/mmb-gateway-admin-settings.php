...
$admin_fields_array['enabled'] = array(
    ...
    'type' => 'checkbox',
    'label' => __('Enable Moneta Gateway', 'mmb-gateway-woocommerce'),
...
$admin_fields_array['title'] =  array(
    ...
    'desc_tip' => true,
    'default' => __('Moneta', 'mmb-gateway-woocommerce')
);
...
$admin_fields_array['description'] =  array(
    ...
    'default' => __("Pay via Moneta", 'mmb-gateway-woocommerce')
);

$admin_fields_array['testmode'] =  array(
    'title' => __('Moneta Test Mode', 'mmb-gateway-woocommerce'),
    'type' => 'checkbox',
...
$admin_fields_array['api_merchant'] = array(
    ...
    'type' => 'title',
    'description' => __('In this section You can set up your merchant data for Moneta system.', 'mmb-gateway-woocommerce')
);
...
if($show_url_fields_sandbox){
    $admin_fields_array['api_urls'] = array(
        ...
        'type' => 'title',
        'description' => __('In this section You can set up Moneta system URLs.', 'mmb-gateway-woocommerce')
    );
    $admin_fields_array['api_test_urls'] = array(
        'title' => __('Test URLs', 'mmb-gateway-woocommerce'),
        'type' => 'title',
        'description' => __('In this section You can set up Moneta test system URLs.', 'mmb-gateway-woocommerce')
    );
